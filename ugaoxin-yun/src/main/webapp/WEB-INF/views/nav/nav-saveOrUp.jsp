              ...
              <form class="form-horizontal" id="saveOrUp">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    ...
                    <input class="form-control" type="text" name="menuName" placeholder="目录名称" value="${nav.menuName }">
                  </div>
                </div>
               
                <div class="form-group row">
                  <label class="control-label col-md-3">目录图标</label>
                  <div class="col-md-8"> 
                      <input class="form-control" type="text" name="menuIcon" placeholder="目录图标" value="${nav.menuIcon }">
